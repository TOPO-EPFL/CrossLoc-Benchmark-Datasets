...
def main(args):
    ...
    print('===== Naturescape dataset setup starts =====')
    ...
    for mode in ['lhs_sim', 'drone_sim', 'drone_real', 'oop_drone_sim', 'oop_drone_real',
        ...
        split_data(os.path.join(dst_dir, mode), mode, 'naturescape', args.ignore_3d_label)
    ...
    print('===== Naturescape dataset setup is done =====')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Setup CrossLoc Benchmark Naturescape dataset.',
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument('--dataset_dir', type=str, required=True,
                        help='Dataset storing the structured datasets.')

    parser.add_argument('--lhs_dir', type=str, default='naturescape-LHS',
    ...
    parser.add_argument('--output_dir', type=str,
                        default=os.path.abspath(os.path.join(os.path.dirname(__file__), 'naturescape')),
